...
<table id="dg" title="书籍信息管理" class="easyui-datagrid" pagination="true"
    ...
    <tr>
        ...
        <th field="title" width="250" align="center">书名</th>
        <th field="author" width="100" align="center">作者</th>
        <th field="isbn" width="150" align="center">ISBN码</th>
        <th field="path" width="100" align="center" formatter="formatProPic">图片</th>
        <th field="marketPrice" width="100" align="center">市场价</th>
        <th field="pages" width="85" align="center">页数</th>
        <th field="publisher" width="150" align="center">出版社</th>
        <th field="binding" width="10" align="center" hidden="true">装订方式</th>
        <th field="hot" width="10" align="center" hidden="true">热度值</th>
        <th field="status" width="85" align="center"
            formatter="formatStatus">上架状态
        </th>
        <th field="supply" width="85" align="center">库存</th>
    </tr>
    </thead>
</table>
<div id="tb">
