...
<table id="dg" title="客户信息管理" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true"
    ...
    <tr>
        ...
        <th field="userName" width="50" align="center">客户名称</th>
        <th field="userName" width="50" align="center">联系电话</th>
        <th field="userName" width="50" align="center">联系地址</th>
        <th field="userName" width="50" align="center">邮编</th>
        <th field="userName" width="50" align="center">备注</th>
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            <tr>
                <td>客户名：</td>
                <td>
                    <input type="text" id="customsName" name="userName" class="easyui-validatebox" required="true"/>&nbsp;
                    <font color="red">*</font>
                </td>
            </tr>
            <tr>
                <td>电话：</td>
                <td>
                    <input type="text" id="customsPhone" name="userName" class="easyui-validatebox" required="true"/>&nbsp;
                    <font color="red">*</font>
                </td>
            </tr>
            <tr>
                <td>地址：</td>
                <td>
                    <input type="text" id="customsAddress" name="userName" class="easyui-validatebox" required="true"/>&nbsp;
                    <font color="red">*</font>
                </td>
            </tr>
            <tr>
